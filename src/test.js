...
const data = [
  ...
  "Weymouth Dorchester Rd",
  "Nailsworth",
  "Coalville Whitwick Road",
  "Cromer Holt Rd",
  "Gosport Walpole Rd",
  "Burntwood High St",
  "Caernarfon North Rd",
  "Frodsham",
  "Reading Basingstoke Lane",
  "Cardiff Bay",
  "Barry Heol Ceiniog",
  "Peterborough Lincoln Rd",
  "Grantham Isaac Newton Centre",
  "Cheltenham Up Hatherley",
  "Melton Mowbray Sherrard St",
  "Loughborough Thorpe Acre",
  "Wakefield Dewsbury Road",
  "Tynemouth Preston Grange",
  "Whitley Bay Hillheads Rd",
  "Swindon Haydon Wick",
  "Kingsbridge",
  "Holyhead Penrhos",
  "Stranraer London Rd",
  "Leicester Freemans Pk",
  "Horndean Lakesmere Rd",
  "Hinckley Stoke Rd",
